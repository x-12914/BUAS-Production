...
def upload_device_data(device_id):
    ...
    try:
        ...
        # 4. Handle app data (store in device info)
        ...
        return jsonify({
            ...
            'installed_apps_count': len(app_data.get('installed_apps', [])) if isinstance(app_data, dict) else 0
        }), 200
